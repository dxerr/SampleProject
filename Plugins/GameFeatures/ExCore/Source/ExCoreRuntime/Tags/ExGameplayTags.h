...
// ========== Debug Tags ==========
// 디버그 시스템 카테고리별 토글 태그
EXCORERUNTIME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ex_Debug_Path);
EXCORERUNTIME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ex_Debug_Chunk);
EXCORERUNTIME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ex_Debug_Slope);
EXCORERUNTIME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ex_Debug_Speed);
EXCORERUNTIME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ex_Debug_Movement);
EXCORERUNTIME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ex_Debug_GodMode);
EXCORERUNTIME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ex_Debug_Collision);
