...
| 날짜 | 변경 내용 |
|------|-----------|
| 2026-02-12 | 초기 구현 완료 (8단계). Spline Mesh 커브, 데이터 드리븐, 꽈배기 바운딩, 캐릭터 회전 |
| 2026-02-12 | 3개 치명 버그 수정: SpawnNextChunk 경로 연동, OnWorldShifted 부호 수정, KillZ PathDistance 기반 전환 |
| 2026-02-12 | **장애물/Chunk 연동 심화**: 4분면(90도) 시스템 확정, 장애물 PathDistance/Rotation 동기화 구현 완료 |
| 2026-02-12 | 가이드 문서 최신화: 장애물 시스템 섹션 추가, 향후 계획(꽈배기/낙하/점프회전) 추가 |
